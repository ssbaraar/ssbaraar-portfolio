      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-14">
        <div className="grid gap-10 md:grid-cols-[1.4fr_1fr_1fr]">
          ...
          <div>
            <Link
              href="/#top"
              className="inline-flex items-center gap-2.5 font-display text-base font-semibold"
            >
              <span className="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-foreground font-display text-sm font-bold text-background">
                B
              </span>
              Baraar Sreesha
            </Link>
            ...
            <p className="mt-4 font-mono-jb text-xs text-muted-foreground/70">
